          ...
          <view class="xw-tool-else">
            <view v-for="(v, index) in item.else" :key="index">
              <uni-badge
                ...
                absolute="rightTop"
                size="normal"
                ><image :src="v.content" mode="aspectFill"></image
              ></uni-badge>
              <image
                v-if="v.type == 'img'"
                :src="v.content"
              ...
              <uni-badge
                ...
                absolute="rightTop"
                size="normal"
                ><view class="text">{{ v.content }}</view></uni-badge
              >
