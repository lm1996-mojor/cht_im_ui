<template>
		<image style="width: 40px; height: 40px;" class="zmm-upload-avatar" :src="modelValue>0?`../../static/img/avatar/avatar${modelValue}.jpg`:modelValue"  mode="aspectFill" @click="selectImage"></image>
</template>
