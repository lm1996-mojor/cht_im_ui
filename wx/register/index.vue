	...
	<view class="wx-login">
			...
			<form @submit="sublogin">
				...
				<view class="xw-login-form-item">
					...
					<image class="uni-list-chat__header-image"
						:style="{ width: 40 + 'px', height: 40 + 'px' }" :src="`../../static/img/avatar/avatar${avatar}.jpg`"
						mode="aspectFill"
						@click="openImgs"></image>
				</view>
				<view class="xw-login-form-item">
					<view class="xw-login-form-label">昵称</view>
					<input class="xw-login-form-input" placeholder="请输入你的昵称" type="text" name="nickname"
						v-model="nickname" />
				</view>
				<view class="xw-login-form-item">
              ...
              selectDate || '请选择你的生日'
				...
				<view class="xw-login-form-item">
					...
					<input class="xw-login-form-input" maxlength="11" placeholder="请填写账号" type="text" name="account"
						v-model="account" />
					<view class="login-form-icon login-form-seepass" @click="account = ''">
				...
				<view class="xw-login-form-item">
					...
					<input class="xw-login-form-input" placeholder="请输入确认密码" name="confirmPassword"
						:password="showConfirmPwd" type="text" v-model="confirmPassword" />
					<view class="login-form-icon login-form-seepass" @click="changeConfirmPassword">
						<image src="../../static/img/l03.png" mode="aspectFill" v-if="showConfirmPwd"></image>
						<image src="../../static/img/l04.png" mode="aspectFill" v-else></image>
					</view>
				</view>
		...
		<uni-drawer ref="circleDrawer" mode="right" :mask-click="true" :show="false" :width="windowWidth" class="circle-drawer">
			<view class="drawer-content">
				<image v-for="item in 45" :key="item" @click="selectImg(item)" class="uni-list-chat__header-image"
					:style="{ width: 60 + 'px', height: 60 + 'px' }" :src="`../../static/img/avatar/avatar${item}.jpg`"
					mode="aspectFill"
					></image>
			</view>
		</uni-drawer>
