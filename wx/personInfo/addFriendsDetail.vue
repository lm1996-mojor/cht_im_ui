    ...
    <view class="person-wx">
      <view class="person-wx-user">
        <image
          ...
          @click="$fc.previewImagesolo(userdetail.avatar)"
          :src="
            userdetail.avatar > 0
              ? `../../static/img/avatar/avatar${userdetail.avatar}.jpg`
              : userdetail.avatar
          "
          mode="aspectFill"
        ></image>
        <view class="person-wx-user-detail">
          <view class="person-wx-nikename">
            ...
            <view
              class="wxfont person-wx-nikename-icon"
              :class="{ nv: userdetail.gender == '0' }"
              v-if="userdetail.gender == '0'"
            ></view>
            <view
              class="wxfont person-wx-nikename-icon"
              :class="{ nan: userdetail.gender == '1' }"
              v-if="userdetail.gender == '1'"
            ></view>
          </view>
          <text class="person-wx-name"> 微聊号：{{ userdetail.account }} </text>
          <text class="person-wx-name"
            >地区：{{ userdetail.provinces || '暂无' }}
    ...
    itemClick(e, i) {
      switch (i) {
        case 0:
          uni.navigateTo({
            url:
              '../search-friends/add?userId=' +
              this.userdetail.userId +
              '&source=' +
              this.userdetail.source
          })
          break
        default:
          break
