      ...
      <view class="person-wx-user">
        ...
        <view class="wxnearby-item-content">
          ...
          <view class="wxmsglist-right">
            ...
            <image
              v-if="v.topicType == 'IMAGE'"
              class="wxmsglist-right-cimg"
              :src="returnParse(v.topicContent).files[0].url"
              mode="aspectFill"
            ></image>
            <view
              class="friendsCircle-content-video"
              v-if="v.topicType == 'VIDEO'"
            >
              <image
                class="friendsCircle-content-video-icon"
                src="../../static/img/bf.png"
                mode="aspectFill"
              ></image>
              <image
                class="friendsCircle-content-video-img"
                :src="returnParse(v.topicContent).files[0].url"
                mode="aspectFill"
              ></image>
            </view>
