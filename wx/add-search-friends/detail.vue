	...
	<view class="bgColor">
		...
		<view class="user-info-box">
			<view class="avatar-left">
				<user-avatar class="user-avatar" :modelValue="userInfo.avatar" ></user-avatar>
			</view>
			<view class="info-right">
				<view class="user-nickname">{{ userInfo.nickname || '用户昵称' }}</view>
				<view class="user-account">微聊号：{{ userInfo.userId || form.userId }}</view>
				<view class="user-signature">{{ userInfo.signature || '该用户暂无个人介绍' }}</view>
			</view>
		</view>
		...
		<view class="user-menu-list">
			...
			<view class="menu-item" @click="goUserProfile">
				<view class="menu-icon">
					<uni-icons type="contact-filled" size="30" color="#2D8CF0"></uni-icons>
				</view>
			...
			<view class="menu-item" @click="goUserCircle">
				<view class="menu-icon">
					<uni-icons type="moments-filled" size="30" color="#FF9500"></uni-icons>
				</view>
...
export default {
	...
	methods: {
		...
		subform() {
			...
			var formData = JSON.parse(JSON.stringify({friendId:this.form.userId,message:this.form.message}));
