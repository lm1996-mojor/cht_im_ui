<template>
  <view class="bgColor" v-if="detail">
    <view class="wxgroup-list">
      <view
        class="wxgroup-list-item"
        v-for="(v, i) in detail.memberList"
        @click="gofriend(v)"
        :key="i"
      >
        <user-avatar
          class="wxgroup-list-img"
          :modelValue="v.userInfo.avatar"
          :is-action="false"
          mode="aspectFill"
        ></user-avatar>
    ...
    <view class="wxgroupInfo">
      <view class="xw-tool-list">
        <view class="xw-tool-list-content">
          <view class="xw-tool-item">
            ...
            <switch
              color="#05C160"
              :checked="Baneddisturb"
              @change="switchChange($event, 'xxmdr')"
        ...
        <view class="xw-tool-list-content">
          <view class="xw-tool-item">
            ...
            <switch
              color="#05C160"
              :checked="BanedTalk"
              @change="switchChange($event, 'qyjy')"
              style="transform: scale(0.75)"
            />
          </view>
        </view>
        <view class="xw-tool-list-content">
          <view class="xw-tool-item">
            ...
            <switch
              color="#05C160"
              :checked="Banedtop"
              @change="switchChange($event, 'zdlt')"
              style="transform: scale(0.75)"
            />
          </view>
        </view>
        <view class="xw-tool-list-content">
          <view class="xw-tool-item">
            ...
            <switch
              color="#05C160"
              :checked="BanedkeepGroup"
              @change="switchChange($event, 'bcdtxl')"
              style="transform: scale(0.75)"
            />
          </view>
        </view>
      ...
      <view class="xw-tool-list">
        <view
          class="xw-tool-list-content"
          v-if="detail.master == 'Y'"
          @click="jiesan"
        >
          <view class="xw-tool-btn-item">
            <view class="xw-tool-btn-text" style="color: #ff5a5f"
              >解散该群</view
            >
          </view>
        </view>
      ...
      return [
        ...
        },
        {
          ...
          path: '#',
            ...
            {
              type: 'text',
              content: this.detail?.announcement
    ...
    switchChange(e, type) {
      ...
      switch (type) {
        case 'xxmdr':
          ...
          var data = JSON.parse(
            JSON.stringify(this.$store.state.chatlist[this.param])
          )
      ...
      this.$http.request({
        ...
        success: res => {
          if (res.data.code == 200) {
            ...
            const data = this.detail.memberList.find(
